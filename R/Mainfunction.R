...
#' DataInfo.link(data = beetles, diversity = 'PD', col.distM = beetles_col_distM)
#' @export
...
#'
#' @param outcome a table generated from SC.link function
...
#'
#' \code{Asy.link}: The estimated diversity of order q
#'
#' @param data a \code{list} of \code{data.frames}, each \code{data.frames} represents col.species-by-row.species abundance matrix.
#' @param diversity selection of diversity type: \code{'TD'} = Taxonomic diversity, \code{'PD'} = Phylogenetic diversity, and \code{'FD'} = Functional diversity.
#' @param q a numerical vector specifying the diversity orders. Default is \code{c(0,1,2)}.
...
#' ## Taxonomic diversity
#' data(beetles)
#' output1 = Asy.link(data = beetles, diversity = 'TD', q = seq(0, 2, 0.2))
#' output1
#'
#'
#' ## Phylogenetic diversity
#' data(beetles)
#' data(beetles_col_tree)
#' output2 = Asy.link(data = beetles, diversity = 'PD', q = seq(0, 2, 0.2), col.tree = beetles_col_tree)
#' output2
#'
#'
#' ## Functional diversity under single threshold
#' data(beetles)
#' data(beetles_col_distM)
#' output3 = Asy.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "tau_values")
#' output3
#'
#'
#' ## Functional diversity with thresholds integrating from 0 to 1
#' data(beetles)
#' data(beetles_col_distM)
#' output4 = Asy.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "AUC")
#' output4
#' @export
...
#'
#' \code{Obs.link}: The empirical diversity of order q
#'
#' @param data a \code{list} of \code{data.frames}, each \code{data.frames} represents col.species-by-row.species abundance matrix.
#' @param diversity selection of diversity type: \code{'TD'} = Taxonomic diversity, \code{'PD'} = Phylogenetic diversity, and \code{'FD'} = Functional diversity.
#' @param q a numerical vector specifying the diversity orders. Default is \code{c(0,1,2)}.
...
#' ## Taxonomic diversity
#' data(beetles)
#' output1 = Obs.link(data = beetles, diversity = 'TD', q = seq(0, 2, 0.2))
#' output1
#'
#'
#' ## Phylogenetic diversity
#' data(beetles)
#' data(beetles_col_tree)
#' output2 = Obs.link(data = beetles, diversity = 'PD', q = seq(0, 2, 0.2), col.tree = beetles_col_tree)
#' output2
#'
#'
#' ## Functional diversity under single threshold
#' data(beetles)
#' data(beetles_col_distM)
#' output3 = Obs.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "tau_values")
#' output3
#'
#'
#' ## Functional diversity with thresholds integrating from 0 to 1
#' data(beetles)
#' data(beetles_col_distM)
#' output4 = Obs.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "AUC")
#' output4
#'
#' @export
Obs.link <- function(data, diversity = 'TD', q = seq(0, 2, 0.2), datatype = "abundance", nboot = 50, conf = 0.95,
                     col.tree = NULL, row.tree = NULL,PDtype = "meanPD", row.distM = NULL, col.distM = NULL, FDtype = "AUC", FDtau = NULL){
  if(diversity == 'TD'){
...
#' data(beetles)
#' output1 = Obs.link(data = beetles, diversity = 'TD', q = seq(0, 2, 0.2))
#' ggObs.link(output1, diversity = 'TD')
#'
#'
#' ## Phylogenetic diversity
#' data(beetles)
#' data(beetles_col_tree)
#' output2 = Obs.link(data = beetles, diversity = 'PD', q = seq(0, 2, 0.2), col.tree = beetles_col_tree)
#' ggObs.link(output2, diversity = 'PD')
#'
#'
#' ## Functional diversity under single threshold
#' data(beetles)
#' data(beetles_col_distM)
#' output3 = Obs.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "tau_values")
#' ggObs.link(output3, diversity = 'FD')
#'
#'
#' ## Functional diversity with thresholds integrating from 0 to 1
#' data(beetles)
#' data(beetles_col_distM)
#' output4 = Obs.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "AUC")
#' ggObs.link(output4, diversity = 'FD')
#' @export
...
#' data(beetles)
#' output1 = Asy.link(data = beetles, diversity = 'TD', q = seq(0, 2, 0.2))
#' ggAsy.link(output1, diversity = 'TD')
#'
#'
#' ## Phylogenetic diversity
#' data(beetles)
#' data(beetles_col_tree)
#' output2 = Asy.link(data = beetles, diversity = 'PD', q = seq(0, 2, 0.2), col.tree = beetles_col_tree)
#' ggAsy.link(output2, diversity = 'PD')
#'
#'
#' ## Functional diversity under single threshold
#' data(beetles)
#' data(beetles_col_distM)
#' output3 = Asy.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "tau_values")
#' ggAsy.link(output3, diversity = 'FD')
#'
#'
#' ## Functional diversity with thresholds integrating from 0 to 1
#' data(beetles)
#' data(beetles_col_distM)
#' output4 = Asy.link(data = beetles, diversity = 'FD', q = seq(0, 2, 0.2), col.distM = beetles_col_distM, FDtype = "AUC")
#' ggAsy.link(output4, diversity = 'FD')
#' @export
    ...
    for_each_region = function(data_2d, region_name, N){
      if (datatype=='abundance') {
        ...
        res = data.frame(Assemblage = rep(region_name,len),
                         goalSC = rep(level, rep(len,length(size_m))),
                         SC = rep(iNEXT.3D:::Coverage(data_2d, datatype='abundance', size_m), rep(len,length(size_m))),
...
iNEXTbeta.link = function(data, diversity = 'TD', level = seq(0.5, 1, 0.05), datatype='abundance',
  ...
  if(diversity == 'TD'){
    ...
    dissimilarity <- iNEXTbeta(data = combined_list, diversity = 'FD',level = level, datatype = datatype,
